...
#Seteo de ventana del player 2
screen=pygame.display.set_mode((300,300))
ico=pygame.image.load('imagenes/icon2.jpg')
...
def main():
    #Creacion de cada rectangulo que compone el tablero
...
def abc(first,second,third,fourth,fifth,sixth,seventh,eighth,nineth):
        #Variables que ayudarán a controlar el juego
        b=1
        s1=0
        s2=0
        s3=0
        ...
        cross = pygame.image.load('imagenes/cross.jpg')
        circle = pygame.image.load('imagenes/circle.jpg')
        win1 = pygame.image.load('imagenes/win1.jpg')
        win2 = pygame.image.load('imagenes/win2.jpg')
        draw = pygame.image.load('imagenes/draw.jpg')
        pygame.display.flip()

        while 1:
            d+=1
            #Conexión a través de socket localhost
            ...
            #messa obtiene la posicion en la que jugo el cliente
            messa=so1.recv(1024)
            
            """
            co toma el atributo de messa de forma b'x 
            y solo retorna el numero x que indica la posicion
            elegida en la jugada del cliente
            """
            co=int(messa)
            print(co)
